...
VALUES
    (
        'cc78f65d-5289-428e-9bf6-c19953521f6a',
        'Rohat',
        'Sagar',
        'rohat-sagar.urif-sonu@informatik.hs-fulda.de',
        'fdcfd0eb2f18fcfc16229143939109aa09d33619797ab685cef7bdebf48c29e7',
        true
    );
...
VALUES
    (
        'c67e42ce-fd6d-4b62-b0df-aaee8003902d',
        'Nisha',
        'Devi',
        'nisha.devi@informatik.hs-fulda.de',
        'b89a61619bbc2a3d21afce76b35587f9ed796e30b873a83f6ab985f7a3522987',
        true
    );
...
CREATE TABLE public.messaging_configuration (
    user_id uuid NOT NULL,
    token TEXT NOT NULL,
    modified_on_utc TIMESTAMP NOT NULL,
    PRIMARY KEY (user_id)
