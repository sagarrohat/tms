...
namespace Persistence
{
    ...
    {
        public virtual DbSet<MessagingConfiguration> MessagingConfigurations { get; set; } = null!;
        ...
        {
            builder.Entity<MessagingConfiguration>(x =>
            {
                x.ToTable("messaging_configuration");
                ...
                x.Property(e => e.ModifiedOnUtc).HasColumnType("timestamp without time zone")
                    .HasColumnName("modified_on_utc");
                x.Property(e => e.Token).HasColumnName("token");
            ...
            builder.Entity<Task>(x =>
            {
                ...
                x.Property(e => e.AssignedOnUtc).HasColumnType("timestamp without time zone")
                    .HasColumnName("assigned_on_utc");
                x.Property(e => e.AssignedUserId).HasColumnName("assigned_user_id");
                x.Property(e => e.CancelledOnUtc).HasColumnType("timestamp without time zone")
                    .HasColumnName("cancelled_on_utc");
                x.Property(e => e.CompletedOnUtc).HasColumnType("timestamp without time zone")
                    .HasColumnName("completed_on_utc");
                x.Property(e => e.CreatedBy).HasColumnName("created_by");
                x.Property(e => e.CreatedOnUtc).HasColumnType("timestamp without time zone")
