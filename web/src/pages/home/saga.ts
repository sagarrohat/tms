...
export function* toggleTab(): Generator<any, any, any> {
...
export function* fetchAssignableUsers(): Generator<any, any, any> {
...
export function* fetchTasks(): Generator<any, any, any> {
...
export function* pinTask(action: any): Generator<any, any, any> {
...
export function* unpinTask(action: any): Generator<any, any, any> {
  const { id } = action.payload;
